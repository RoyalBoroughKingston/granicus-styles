...
if (window.location.href.indexOf("fillform") > -1) {
    ...
    $('<link href="https://fs-filestore-eu.s3-eu-west-1.amazonaws.com/rbkingston/Branding/dev/css/core.css" rel="stylesheet">').appendTo("head");
	$('<link href="https://fs-filestore-eu.s3-eu-west-1.amazonaws.com/rbkingston/Branding/dev/css/form.css" rel="stylesheet">').appendTo("head");
}
